...
contract NFTPerpOrderTest is Test {
    ...
    function setUp() public {
        ...
        uint256 currentPrice = MOON_BIRD_AMM.getMarkPrice().toUint();
...
//         // execute order
//         _executeOrder(_orderHash);
//         console.log(IClearingHouse(clearingHouse).getPosition(MOON_BIRD_AMM, address(_account)).margin.toUint());
